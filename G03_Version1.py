...
while (running):
    ...
    # pg.draw.polygon(screen, light_blue, ((650,35),(650,135),()))
    ...
    if toggle_start == 1:
        ...
        if (pos_y <= ini_sy-0.35*scale_multiplier):  # run simulation
    ...
    screen.blit(TextBox(blue,
                'Squash ball shooter simulation').txt_surface, (850, 35))
    ...
    screen.blit(TextBox(black,
                "X displacement from start : {x_pos} m".format(x_pos=curr_x_distance)).txt_surface, (5, 5))
    screen.blit(TextBox(black,
                "Y displacement from ground : {y_pos} m".format(y_pos=curr_y_distance)).txt_surface, (5, 30))
