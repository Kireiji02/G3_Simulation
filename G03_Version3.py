...
def Initiate_sim(toggle_start, last_t, pos_y_max, reset_text_toggle, t):
    # toggleable simulation
    if toggle_start == 1:
        # dotted tracing#---------------------------------------------------------------------------------------------------#
        squash.dots_track(t, speed_multiplier)
        # position vector#---------------------------------------------------------------------------------------------------#
        ...
        squash.draw(screen, scale_multiplier)
    return toggle_start, last_t, pos_y_max, reset_text_toggle, t


def Reset_sim(toggle_reset, toggle_start, reset_text_toggle, t):
    if toggle_reset == 1:
        ...
        toggle_start = 0
        t = 0
    return toggle_reset, toggle_start, reset_text_toggle, t


def inputbox_return(enter_switch, text, return_text, active_status, output, multiplier=1):
    if return_text != '':
        output = int(text)/multiplier
        return_text = ''
        enter_switch = 0
    if return_text == '':
        if active_status:
            ...
            enter_switch = 0
    return enter_switch, return_text, active_status, output
...
while (running):
    ...
    enter_switch_1, input_box1.return_text, input_box1.active, deg = inputbox_return(
        enter_switch_1, input_box1.text, input_box1.return_text, input_box1.active, deg)

    enter_switch_2, input_box2.return_text, input_box2.active, s1 = inputbox_return(
        enter_switch_2, input_box2.text, input_box2.return_text, input_box2.active, s1, 1000)

    enter_switch_3, input_box3.return_text, input_box3.active, s2 = inputbox_return(
        enter_switch_3, input_box3.text, input_box3.return_text, input_box3.active, s2, 1000)

    enter_switch_4, input_box4.return_text, input_box4.active, wall = inputbox_return(
        enter_switch_4, input_box4.text, input_box4.return_text, input_box4.active, wall, 100)
    ...
    # simulation init#
    toggle_start, last_t, pos_y_max, reset_text_toggle, t = Initiate_sim(
        toggle_start, last_t, pos_y_max, reset_text_toggle, t)
    # simulation reset#
    toggle_reset, toggle_start, reset_text_toggle, t = Reset_sim(
        toggle_reset, toggle_start, reset_text_toggle, t)
    ...
    [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch] = x_01.takeaction(
        [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch], [1, 0, 0, 0, 0])
    [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch] = x_02.takeaction(
        [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch], [0, 1, 0, 0, 0])
    [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch] = x_05.takeaction(
        [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch], [0, 0, 1, 0, 0])
    [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch] = x_08.takeaction(
        [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch], [0, 0, 0, 1, 0])
    [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch] = x_1.takeaction(
        [x_01_switch, x_02_switch, x_05_switch, x_08_switch, x_1_switch], [0, 0, 0, 0, 1])
